    ...
    <div className="grid grid-cols-4 gap-2">
      {links.map((link, idx) => (
        <Link key={idx} href={link.path}>
          <div className="bg-accent sm:opacity-80 sm:hover:opacity-100 text-accent-foreground text-sm sm:text-base px-3 sm:px-6 lg:px-8 py-4 rounded-xl flex items-center justify-between">
